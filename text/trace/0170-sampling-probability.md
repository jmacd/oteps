...
| <b>(p<sub>1</sub>∈[1,62], sampled<sub>1</sub>=true)<br>(p<sub>1</sub>=63, sampled<sub>1</sub>=false) | p=p<sub>1</sub> or<br>sampled=logicalOr(sampled<sub>0</sub>, sampled<sub>1</sub>) | p=min(p<sub>0</sub>, p<sub>1</sub>),<br>sampled=logicalOr(sampled<sub>0</sub>, sampled<sub>1</sub>)</b> |
|                                                                                                   |                                                                                 |                                                                                                     |
