...
| --                                                                                                     | --                                                                       | --                                                                                           |
| p<sub>1</sub>=0 sampled<sub>1</sub>∈{true,false}                                                       | p=0 <br> sampled=or(sampled<sub>0</sub>, sampled<sub>1</sub>)            | p=p<sub>0</sub><br> sampled=or(sampled<sub>0</sub>, sampled<sub>1</sub>)                     |
| (p<sub>1</sub>∈[1,62] sampled<sub>1</sub>=true) OR<br>(p<sub>1</sub>=63 AND sampled<sub>1</sub>=false) | p=p<sub>1</sub><br> sampled=or(sampled<sub>0</sub>, sampled<sub>1</sub>) | p=min(p<sub>0</sub>, p<sub>1</sub>)<br> sampled=or(sampled<sub>0</sub>, sampled<sub>1</sub>) |
|                                                                                                        |                                                                          |                                                                                              |
